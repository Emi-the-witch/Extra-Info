...
//		d.add();
	...
	private abstract static class Clear extends TerrainClearing {
		...
		private final Sound sound = AUDIO.mono().get("CLEAR_WATER");
		@Override
		...
		@Override
		public Sound sound(int tx, int ty) {
			return sound;
		}
	...
	public void renderOverlayed(RenderIterator i) {
...
//		}
	...
	private abstract class DeepAbs extends TerrainTile{
		...
		@Override
		protected final boolean renderBelow(SPRITE_RENDERER r, ShadowBatch s, RenderIterator i, int data) {
			int d = 0;
...
//		}
	...
	private static class Sprites {
		...
		void renderTexture(RenderIterator i) {
